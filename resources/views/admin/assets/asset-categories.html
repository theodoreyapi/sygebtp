									...
									<ul class="nav-menu">
										...
										<li class="submenu">
											...
											<ul>
												...
												<li class="submenu">
													<a href="javascript:void(0);" class="active subdrop"><span>Assets</span>
														<span class="menu-arrow"></span>
													</a>
													<ul>
														<li><a href="assets.html">Assets</a></li>
														<li><a href="asset-categories.html" class="active">Asset Categories</a></li>
													</ul>
												</li>
												<li class="submenu">
		...
		<div class="modal fade" id="add_assets">
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					...
					<form action="asset-categories.html">
				...
				<div class="modal-content">
					<div class="modal-body text-center">
						...
						<div class="d-flex justify-content-center">
							...
							<a href="asset-categories.html" class="btn btn-danger">Yes, Delete</a>
						</div>
					</div>
				</div>
			</div>
