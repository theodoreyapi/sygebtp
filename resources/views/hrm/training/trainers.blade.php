...
@section('content')
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center file-name-icon">
                                            <div class="ms-2">
                                                <h6 class="fw-medium"><a href="#">{{ $item->name_trai }}
                                                        {{ $item->lastname_trai }}</a></h6>
                                                {{ $item->role_trai }}
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td>{{ $item->email_trai }}</td>
                                    <td>
                                        <div style="word-break: break-word; white-space: normal; max-width: 300px;">
                                            {{ $item->description_trai }}
                                        </div>
                                    </td>
                                    <td>
                                        @if ($item->status_train == 'Active')
                                    ...
                                    <td>
                                        <div class="action-icon d-inline-flex">
                                            <a href="#" class="me-2" data-bs-toggle="modal"
                                                data-bs-target="#edit_trainer{{ $item->trai }}"><i
                                                    class="ti ti-edit"></i></a>
                                            <a href="#" data-bs-toggle="modal"
                                                data-bs-target="#delete_modal{{ $item->trai }}"><i
                                                    class="ti ti-trash"></i></a>
                                        </div>
                                        <!-- Edit Trainer -->
                                        <div class="modal fade" id="edit_trainer{{ $item->trai }}">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('trainers.update', $item->trai) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('PATCH')
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" name="email" required
                                                                            class="form-control"
                                                                            value="{{ $item->email_trai }}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Description</label>
                                                                        <textarea name="description" placeholder="Une description sur lui" class="form-control">
                                                                            {{ $item->description_trai }}
                                                                        </textarea>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select name="statut" required class="select">
                                                                            <option
                                                                                @if ($item->status_train == 'Active') selected @endif
                                                                                value="Active">Active</option>
                                                                            <option
                                                                                @if ($item->status_train == 'Inactive') selected @endif
                                        ...
                                        <!-- Delete Modal -->
                                        <div class="modal fade" id="delete_modal{{ $item->trai }}">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-body text-center">
                                                        ...
                                                        <form action="{{ route('trainers.destroy', $item->trai) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('DELETE')
    ...
    <div class="modal fade" id="add_trainer">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajout d'un formateur</h4>
                    ...
                    <div class="modal-body pb-0">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Description</label>
                                    <textarea name="description" placeholder="Une description sur lui" class="form-control"></textarea>
                                </div>
                            </div>
