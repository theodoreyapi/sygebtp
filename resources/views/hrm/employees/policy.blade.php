@extends('layouts.master', ['title' => 'Politiques'])
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Politiques</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajout d'une politique</h4>
                ...
                <form action="policy.html">
                    ...
                    <div class="modal-body pb-0">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Nom de la polique</label>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Fichier de politique</label>
