@extends('layouts.master', ['title' => 'Resignation'])
...
@section('content')
            ...
            <div class="my-auto mb-2">
                ...
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Démission</li>
                    </ol>
                </nav>
            </div>
            <div class="d-flex my-xl-auto right-content align-items-center flex-wrap ">
                <div class="mb-2">
                    <a href="#" class="btn btn-primary d-flex align-items-center" data-bs-toggle="modal"
                        data-bs-target="#new_resignation"><i class="ti ti-circle-plus me-2"></i>Ajouter une démission</a>
                </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                        <h5 class="d-flex align-items-center">Liste de démission</h5>
                    </div>
                                            ...
                                            <td>
                                                <div class="action-icon d-inline-flex">
                                                    <a href="#" class="me-2" data-bs-toggle="modal"
                                                        data-bs-target="#edit_resignation{{ $item->resi }}"><i
                                                            class="ti ti-edit"></i></a>
                                                    <a href="#" data-bs-toggle="modal"
                                                        data-bs-target="#delete_modal{{ $item->resi }}"><i
                                                            class="ti ti-trash"></i></a>
                                                </div>

                                                <div class="modal fade" id="edit_resignation{{ $item->resi }}">
                                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="{{ route('resignation.update', $item->resi) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('PATCH')
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <div
                                                                                    class="input-icon-end position-relative">
                                                                                    <input name="demission" required
                                                                                        type="text"
                                                                                        value="{{ $item->resignation_date }}"
                                                                                        class="form-control datetimepicker"
                                                                                        placeholder="dd/mm/yyyy">
                                                                                    <span class="input-icon-addon">
                                                                                        <i
                                                ...
                                                <div class="modal fade" id="delete_modal{{ $item->resi }}">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center">
                                                                ...
                                                                <p class="mb-3">You want to delete all the marked items,
                                                                    this cant be undone once you delete.</p>
                                                                <form
                                                                    action="{{ route('resignation.destroy', $item->resi) }}"
                                                                    method="post">
                                                                    @csrf
                                                                    @method('DELETE')
    ...
    <div class="modal fade" id="new_resignation">
        <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Ajout d'une démission</h4>
                ...
                <form action="{{ route('resignation.store') }}" method="post">
                    ...
                    <div class="modal-body pb-0">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label">Employé démissionnaire</label>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-icon-end position-relative">
                                        <input name="demission" required type="text"
