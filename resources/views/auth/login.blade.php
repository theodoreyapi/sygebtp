					...
					<div class="col-lg-7 col-md-12 col-sm-12">
						<div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
							<div class="col-md-7 mx-auto vh-100">
								<form action="index" class="vh-100" method="GET">
                                    @csrf
									<div class="vh-100 d-flex flex-column justify-content-between p-4 pb-0">
										...
										<div class="">
											<div class="text-center mb-3">
												...
												<p class="mb-0">Veuillez saisir vos coordonnées pour vous connecter</p>
											</div>
											<div class="mb-3">
											...
											<div class="d-flex align-items-center justify-content-between mb-3">
												<div class="d-flex align-items-center">
													<div class="form-check form-check-md mb-0">
														...
														<label for="remember_me" class="form-check-label mt-0">Souviens-toi de moi</label>
													</div>
												</div>
											</div>
											<div class="mb-3">
										...
										<div class="mt-5 pb-4 text-center">
											<p class="mb-0 text-gray-9">Copyright &copy; {{ date('Y') }} - SYGEBTP</p>
										</div>
									</div>
								</form>
							</div>
